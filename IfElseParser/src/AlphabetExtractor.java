/* Purpose: 
 * --------------------------------------------------
 * Since a file is parsed by each byte and an input
 * alphabet for the PDA consist of several bytes, this
 * class handles combining the bytes into a valid
 * input alphabet. It errors out if an invalid parsed
 * is detected.
 */
